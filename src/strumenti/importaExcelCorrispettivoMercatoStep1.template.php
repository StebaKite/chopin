...
class ImportaExcelCorrispettivoMercatoStep1Template extends PrimanotaAbstract {

	private static $_instance = null;

	private static $pagina = "/primanota/importaExcelCorrispettivoMercato.form.html";
	...
	public static function getInstance() {
		...
		if( !is_object(self::$_instance) )
			...
			self::$_instance = new ImportaExcelCorrispettivoMercatoStep1Template();
	...
	public function displayPagina() {
		...
		if (isset($_SESSION["corrispettiviTrovati"])) {
			...
			$corrispettivi_da_importare =
			"<table id='corrispettivi' class='display' width='100%'>" .
			"	<thead>" .
			"		<tr>" .
			"			<th>Data</th>" .
			"			<th>Totale</th>" .
