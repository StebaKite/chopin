...
interface RiepiloghiBusinessInterface extends MainNexus6Interface {
    ...
    const GENERA_QUADRO_PRESENZE_ASSISTITI = "Obj_generaquadropresenzeassistiti";
    ...
    const AZIONE_PRESENZE_ASSISTITO = "../riepiloghi/generaQuadroPresenzeAssistitiFacade.class.php?modo=go";
