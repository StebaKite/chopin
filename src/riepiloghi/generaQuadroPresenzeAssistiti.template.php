...
class GeneraQuadroPresenzeAssistitiTemplate extends RiepiloghiAbstract implements RiepiloghiPresentationInterface {
    ...
    public function displayPagina() {
        ...
        $replace = array(
            ...
            '%selected_1%' => ($presenzaAssistito->getMese() === '1') ? self::SELECT_THIS_ITEM : self::EMPTYSTRING,
            '%selected_2%' => ($presenzaAssistito->getMese() === '2') ? self::SELECT_THIS_ITEM : self::EMPTYSTRING,
            '%selected_3%' => ($presenzaAssistito->getMese() === '3') ? self::SELECT_THIS_ITEM : self::EMPTYSTRING,
            '%selected_4%' => ($presenzaAssistito->getMese() === '4') ? self::SELECT_THIS_ITEM : self::EMPTYSTRING,
            '%selected_5%' => ($presenzaAssistito->getMese() === '5') ? self::SELECT_THIS_ITEM : self::EMPTYSTRING,
            '%selected_6%' => ($presenzaAssistito->getMese() === '6') ? self::SELECT_THIS_ITEM : self::EMPTYSTRING,
            '%selected_7%' => ($presenzaAssistito->getMese() === '7') ? self::SELECT_THIS_ITEM : self::EMPTYSTRING,
            '%selected_8%' => ($presenzaAssistito->getMese() === '8') ? self::SELECT_THIS_ITEM : self::EMPTYSTRING,
            '%selected_9%' => ($presenzaAssistito->getMese() === '9') ? self::SELECT_THIS_ITEM : self::EMPTYSTRING,
