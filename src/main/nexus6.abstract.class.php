...
//        </li>
        ...
        if ($array["strumenti"] == "Y") {
            ...
            if ($array["strumenti_item_1"] == "Y")
                $strumenti .= "<li><a href='../strumenti/importaExcelCorrispettivoNegozioStep1Facade.class.php?modo=start'>" . $array["strumenti_item_1_name"] . "</a></li>";
            if ($array["strumenti_item_2"] == "Y")
                $strumenti .= "<li><a href='../strumenti/importaExcelCorrispettivoMercatoStep1Facade.class.php?modo=start'>" . $array["strumenti_item_2_name"] . "</a></li>";
            if ($array["strumenti_item_3"] == "Y")
                $strumenti .= "<li><a href='../strumenti/cambiaContoStep1Facade.class.php?modo=start'>" . $array["strumenti_item_3_name"] . "</a></li>";
            $strumenti .= "</ul></li>";
        }
        $menu .= $strumenti;
