...
class CreaCorrispettivoNegozio extends primanotaAbstract {
	...
	private static $contoCassaBanca = null;
	...
	function __construct() {
		...
		self::$contoErario = $array['contoErarioNegozio'];
		self::$contoCassaBanca = $array['contoCassaBancaNegozio'];
	}
	...
	public function preparaPagina($creaCorrispettivoNegozioTemplate) {
		...
		*/
		...
		$_SESSION['conto_erario_negozio'] = self::$contoErario;
		$_SESSION['conto_cassabanca_negozio'] = self::$contoCassaBanca;
	}
}
