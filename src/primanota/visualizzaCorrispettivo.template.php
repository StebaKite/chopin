...
class VisualizzaCorrispettivoTemplate extends PrimanotaAbstract {

	private static $_instance = null;

	private static $pagina = "/primanota/visualizzaCorrispettivo.form.html";
	...
	public static function getInstance() {
		...
		if( !is_object(self::$_instance) )
			self::$_instance = new VisualizzaCorrispettivoTemplate();
