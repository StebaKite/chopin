...
//	const DETTAGLIO_REGISTRAZIONE = "Obj_dettaglioregistrazione";
	...
	const AGGIORNA_DETTAGLIO_CORRISPETTIVO = "Obj_aggiornadettagliocorrispettivo";
	const AGGIORNA_TABELLA_DETTAGLIO_REGISTRAZIONE = "Obj_aggiornatabelladettaglioregistrazione";
	...
	const CANCELLA_DETTAGLIO_CORRISPETTIVO = "Obj_cancelladettagliocorrispettivo";
	...
	const VERIFICA_REGISTRAZIONE_DOPPIA = "Obj_verificaregistrazionedoppia";
	...
	const AGGIORNA_DATA_SCADENZA_FORNITORE = "Obj_aggiornadatascadenzafornitore";
	const AGGIORNA_DATA_SCADENZA_CLIENTE = "Obj_aggiornadatascadenzacliente";
