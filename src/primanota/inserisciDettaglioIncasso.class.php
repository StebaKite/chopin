...
class InserisciDettaglioIncasso extends primanotaAbstract {
	...
	public static function getInstance() {
		...
		if( !is_object(self::$_instance) )
			...
			self::$_instance = new InserisciDettaglioIncasso();
	...
	public function go() {
		...
		if ($this->inserisciDettaglioRegistrazione($db, $utility, $_SESSION["idRegistrazione"], $conto, $sottoconto, $importo, $d_a)) {
			...
			error_log("Errore inserimento dettaglio incasso, eseguito Rollback");
		}
