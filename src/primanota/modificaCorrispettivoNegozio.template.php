...
class ModificaCorrispettivoNegozioTemplate extends PrimanotaAbstract {

    private static $_instance = null;
    private static $pagina = "/primanota/modificaCorrispettivoNegozio.form.html";
    ...
    public static function getInstance() {
        ...
        if (!is_object(self::$_instance)) {
            self::$_instance = new ModificaCorrispettivoNegozioTemplate();
        }
