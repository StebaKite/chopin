...
class ProgressivoFattura implements CoreInterface {
	...
	public function getInstance() {
		...
		if (!isset($_SESSION[self::PROGRESSIVO_FATTURA])) $_SESSION[self::PROGRESSIVO_FATTURA] = serialize(new ProgressivoFattura());
