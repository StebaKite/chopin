...
class CategoriaCliente implements CoreInterface
{
	public $root;
    ...
    {
		if (!isset($_SESSION[self::CATEGORIA_CLIENTE])) $_SESSION[self::CATEGORIA_CLIENTE] = serialize(new CategoriaCliente());
