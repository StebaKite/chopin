...
class Fornitore extends CoreBase implements CoreInterface {
    ...
    public function update($db) {
        ...
        $replace = array(
            ...
            '%cod_fornitore%' => $this->getCodFornitore(),
            '%des_fornitore%' => $this->getDesFornitore(),
            '%des_indirizzo_fornitore%' => parent::isEmpty($this->getDesIndirizzoFornitore()) ? parent::NULL_VALUE : "'" . $this->getDesIndirizzoFornitore() . "'",
            '%des_citta_fornitore%' => parent::isEmpty($this->getDesCittaFornitore()) ? parent::NULL_VALUE : "'" . $this->getDesCittaFornitore() . "'",
            '%cap_fornitore%' => parent::isEmpty($this->getCapFornitore()) ? parent::NULL_VALUE : "'" . $this->getCapFornitore() . "'",
            '%tip_addebito%' => $this->getTipAddebito(),
            '%num_gg_scadenza_fattura%' => $this->getNumGgScadenzaFattura()
        );
