...
class EsportaMovimentiSottoconto extends ConfigurazioniAbstract implements ConfigurazioniBusinessInterface
{
	...
	{
		if (!isset($_SESSION[self::ESPORTA_MOVIMENTI_SOTTOCONTO])) $_SESSION[self::ESPORTA_MOVIMENTI_SOTTOCONTO] = serialize(new EsportaMovimentiSottoconto());
	...
	public function generaSezioneIntestazione($pdf, $conto, $sottoconto) {
		...
		if ($negozio != "") $pdf->setTitle1("Negozio di " . $negozio);
