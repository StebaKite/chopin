...
class RicercaScadenzeCliente extends ScadenzeAbstract implements ScadenzeBusinessInterface {
    ...
    public function getInstance() {
        if (!isset($_SESSION[self::RICERCA_SCADENZE_CLIENTE]))
            $_SESSION[self::RICERCA_SCADENZE_CLIENTE] = serialize(new RicercaScadenzeCliente());
    ...
    public function start() {
        ...
        $_SESSION[self::FUNCTION_REFERER] = self::RICERCA_SCADENZE_CLIENTE;
