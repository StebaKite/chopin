...
//        $this->messaggioInfo = $this->root . $this->array[self::INFO];
    ...
    public static function getInstance() {
        if (parent::getIndexSession(self::CANCELLA_PAGAMENTO) === NULL) {
            parent::setIndexSession(self::CANCELLA_PAGAMENTO, serialize(new CancellaPagamento()));
        }
        return unserialize(parent::getIndexSession(self::CANCELLA_PAGAMENTO));
    }
    ...
    public function go() {
        ...
        $scadenzaFornitore->setIdPagamento(self::NULL_VALUE);
