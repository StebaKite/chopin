...
function validaNuovoFornitore() {
    ...
    if (isNotEmpty($("#codforn_cre").val())) {
        if (controllaCodice("codforn_cre")) {
            esito = esito + "1";
        } else {
            esito = esito + "0";
        }
    ...
    if (isNotEmpty($("#desforn_cre").val())) {
        if (controllaDescrizione("desforn_cre")) {
            esito = esito + "1";
        } else {
            esito = esito + "0";
        }
    ...
    if (isNotEmpty($("#ggscadfat_cre").val())) {
        if (controllaQuantita("ggscadfat_cre")) {
            esito = esito + "1";
        } else {
            esito = esito + "0";
        }
...
function validaModificaFornitore() {
    ...
    if (isNotEmpty($("#desforn_mod").val())) {
        if (controllaDescrizione("desforn_mod")) {
            esito = esito + "1";
        } else {
            esito = esito + "0";
        }
    ...
    if (isNotEmpty($("#ggscadfat_mod").val())) {
        if (controllaQuantita("ggscadfat_mod")) {
            esito = esito + "1";
        } else {
            esito = esito + "0";
        }
