...
function validaNuovoMercato() {
    ...
    if (isNotEmpty($("#codmer_cre").val())) {
        if (controllaCodice("codmer_cre")) {
            esito = esito + "1";
        } else {
            esito = esito + "0";
        }
    ...
    if (isNotEmpty($("#desmer_cre").val())) {
        if (controllaDescrizione("desmer_cre")) {
            esito = esito + "1";
        } else {
            esito = esito + "0";
        }
    ...
    if (isNotEmpty($("#citmer_cre").val())) {
        if (controllaDescrizione("citmer_cre")) {
            esito = esito + "1";
        } else {
            esito = esito + "0";
        }
...
function validaModificaMercato() {
    ...
    if (isNotEmpty($("#codmer_mod").val())) {
        if (controllaCodice("codmer_mod")) {
            esito = esito + "1";
        } else {
            esito = esito + "0";
        }
    ...
    if (isNotEmpty($("#desmer_mod").val())) {
        if (controllaDescrizione("desmer_mod")) {
            esito = esito + "1";
        } else {
            esito = esito + "0";
        }
    ...
    if (isNotEmpty($("#citmer_mod").val())) {
        if (controllaDescrizione("citmer_mod")) {
            esito = esito + "1";
        } else {
            esito = esito + "0";
        }
