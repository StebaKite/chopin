...
function visualizzaScadenzaFornitore(idScadenza)
{
	...
	xmlhttp.open("GET","visualizzaScadenzaFornitoreFacade.class.php?modo=start&idScadenza=" + idScadenza, true);
	xmlhttp.send();
}
...
function modificaScadenzaFornitore(idScadenza)
{
	...
	xmlhttp.open("GET","modificaScadenzaFornitoreFacade.class.php?modo=start&idScadenza=" + idScadenza, true);
	xmlhttp.send();
}
